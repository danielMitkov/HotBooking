...
{
    public const int ChilworthLondonPaddingtonId = 1;
    public const int KempinskiHotelGrandArenaId = 2;
    ...
    private Hotel[] GetHotels()
    {
        return new Hotel[]
        {
            new Hotel()
            {
                Id = ChilworthLondonPaddingtonId,
                ...
                StarRating = 5,
                ManagerId = ManagerConfiguration.FirstId
            },
            new Hotel()
            {
                Id = KempinskiHotelGrandArenaId,
