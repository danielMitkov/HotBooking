...
namespace HotBooking.Data.Migrations
{
    ...
    [Migration("20240417113009_DataSeeded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotBooking.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEPWnPrAoVUZNG3BxP028Uo18cOHEC6iv6yS3HeIW4hBvlqDv3WfEjztzApeMBV3y7Q==",
                        ...
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAGjLTIhkH5OsCviHUCYD5IAi9iM4A2BUp5YkVqzlwU+lgauSmWqlr4bU1tqBx8qvg==",
                            PhoneNumberConfirmed = false,
                        ...
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEHMY3F/lmfqCdQr+GoAVCDZNHfJUkt2o8CD2drzjhaCzw5uf74wWsQ//v7XbX7QnIg==",
                            PhoneNumberConfirmed = false,
            ...
            modelBuilder.Entity("HotBooking.Data.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotBooking.Data.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotBooking.Data.Models.Booking", b =>
                {
                    b.HasOne("HotBooking.Data.Models.Cart", "Cart")
                        .WithMany("Bookings")
                    ...
                    b.HasOne("HotBooking.Data.Models.Order", "Order")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("HotBooking.Data.Models.Cart", b =>
                {
                    b.HasOne("HotBooking.Data.Models.ApplicationUser", "User")
                        .WithOne("Cart")
                        .HasForeignKey("HotBooking.Data.Models.Cart", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
